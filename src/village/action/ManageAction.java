...
import village.dao.FangchanDao;
import village.dao.JiaofeiDao;
import village.dao.TousuDao;
import village.dao.UserDao;
import village.dao.WeixiuDao;
import village.dao.ZhuhuDao;
import village.entity.Fangchan;
import village.entity.Jiaofei;
import village.entity.Tousu;
import village.entity.User;
import village.entity.Weixiu;
import village.entity.Zhuhu;
import village.util.Pager;
	...
	public String login() throws IOException {
		...
		if (user!=null) {
			...
			response
					.getWriter()
					.print(
							"<script language=javascript>alert('Wrong Please try again');window.location.href='login.jsp';</script>");
		}
		return null;
	}
	...
	public void changepwd2() throws IOException {
		...
		if(bean!=null){
			...
			response
					.getWriter()
					.print(
							"<script language=javascript>alert('username or password wrong');</script>");
		}
	}
	...
	public void zhuhuadd2() throws IOException {
		...
		if(user!=null){
			...
			response
					.getWriter()
					.print(
							"<script language=javascript>alert('already exist');window.location.href='method!zhuhulist';</script>");
			return;
		}
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!zhuhulist';</script>");
...
//删除业主操作
	...
	public String fangchanlist()  {
		...
		request.setAttribute("pagerinfo", Pager.getPagerNormal(total, pagesize,
				currentpage, "method!fangchanlist", "共有" + total + "条记记录"));
...
//添加房产操作
	public void fangchanadd2() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!fangchanlist';</script>");
...
//添加缴费信息操作
	public void jiaofeiadd2() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!jiaofeilist';</script>");
...
//删除缴费信息操作
	...
	public void jiaofeidelete2() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!jiaofeilist2';</script>");
	}
...
//添加维修操作
	public void weixiuadd2() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!weixiulist';</script>");
...
//添加投诉操作
	public void tousuadd2() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!tousulist';</script>");
...
//处理维修操作
	public void weixiuupdate6() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!weixiulist2';</script>");
	}
...
//处理投诉操作
	public void tousuupdate6() throws IOException {
		...
		response
				.getWriter()
				.print(
						"<script language=javascript>alert('success');window.location.href='method!tousulist2';</script>");
	}
