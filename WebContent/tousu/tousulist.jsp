...
<input type="submit" value="搜索">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <a href="method!tousuupdate3?id=${bean.id }"><span class="label label-primary">查看投诉信息</span></a>
      <a href="method!tousuupdate?id=${bean.id }"><span class="label label-primary">更新投诉信息</span></a>
      <a href="method!tousudelete?id=${bean.id }"><span class="label label-primary">删除投诉信息</span></a>
      </td>
    </tr>
    </c:forEach>
