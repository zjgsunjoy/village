...
<input type="submit" value="搜索">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <a href="method!jiaofeiupdate3?id=${bean.id }"><span class="label label-primary">查看缴费信息</span></a>
      <a href="method!jiaofeiupdate?id=${bean.id }"><span class="label label-primary">更新缴费信息</span></a>
      <a href="method!jiaofeidelete?id=${bean.id }"><span class="label label-primary">删除缴费信息</span></a>
      </td>
    </tr>
    </c:forEach>
