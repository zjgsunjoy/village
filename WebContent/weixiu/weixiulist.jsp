...
<input type="submit" value="搜索">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <a href="method!weixiuupdate3?id=${bean.id }"><span class="label label-primary">查看维修信息</span></a>
      <a href="method!weixiuupdate?id=${bean.id }"><span class="label label-primary">更新维修信息</span></a>
      <a href="method!weixiudelete?id=${bean.id }"><span class="label label-primary">删除维修信息</span></a>
      </td>
    </tr>
    </c:forEach>
