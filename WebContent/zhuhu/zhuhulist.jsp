...
<input type="submit" value="搜索">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <a href="method!zhuhuupdate3?id=${bean.id }"><span class="label label-primary">查看业主信息</span></a>
      <a href="method!zhuhuupdate?id=${bean.id }"><span class="label label-primary">更新业主信息</span></a>
      <a href="method!zhuhudelete?id=${bean.id }"><span class="label label-primary">删除业主信息</span></a>
      </td>
    </tr>
    </c:forEach>
