...
<input type="submit" value="搜索">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="method!userdelete?id=${bean.id }"><span class="label label-primary">停用该账号</span></a>
      <a href="method!userdelete2?id=${bean.id }"><span class="label label-primary">正常使用账号</span></a>
      </td>
    </tr>
    </c:forEach>
