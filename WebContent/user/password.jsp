...
<table class="usertableborder" cellspacing="1" cellpadding="3" width="96%" align="center"
    ...
    <br>
    <form action="method!changepwd2" method="post" onsubmit="return checkform()"><div align="right"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left"><input type="text" name="password1"  id='password1id'></td>
      
    </tr>
    <tr>
      <td align="right">新密码:</td>
      <td align="left"><input type="text" name="password2" id='password2id'></td>
      
    </tr>
     <tr>
      <td align="right">确认新密码:</td>
      <td align="left"><input type="text" name="password3" id='password3id'></td>
